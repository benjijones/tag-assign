...
public class StringUtils {
    ...
    /**
     * NOTE: the following description (modified slightly from the doc at the
     * start of this file) cannot be used until we require Java 1.6 for all JE
     * usage, including Android, since Java 1.5 doesn't provide the
     * String.getBytes(Charset) method that we need.
     *
     * In all src and test code, the String(byte[], ...) constructor and
